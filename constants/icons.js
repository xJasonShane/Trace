/**
 * 图标 SVG 路径常量
 * 集中管理所有图标的 SVG path，便于维护与复用
 * 键名与 Icon 组件的 name prop 对应
 */
export const ICON_PATHS = {
	// TabBar 图标
	map: '<path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/>',
	journal: '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/>',
	...
	// 空状态
	emptyJournal: '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><line x1="9" y1="15" x2="15" y2="15"/>'
}
